...
import { Bus, MapPin, Calendar, Clock, Download, ChevronRight, QrCode, Loader2, AlertCircle } from "lucide-react";
                  ...
                  <div className="flex flex-col md:flex-row">
                    <div className="p-8 flex-grow">
                      <div className="flex justify-between items-start mb-8">
                         <div className="flex items-center gap-3">
                           ...
                           <div>
                              <h3 className="text-lg font-bold text-gray-900">Confirmed Ride</h3>
                              <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">TICKET ID: {ticket.id.substring(0,8).toUpperCase()}</p>
                           </div>
                         </div>
                         <Badge 
                      ...
                      <div className="grid md:grid-cols-3 gap-8">
                         <div className="flex items-center gap-4">
                            <div className="text-center bg-gray-50 px-3 py-2 rounded-lg">
                               ...
                               <p className="text-xs font-bold text-gray-900">
                                 {ticket.bookingDate ? format(new Date(ticket.bookingDate), "MMM dd") : "TBA"}
                               </p>
                            </div>
                            <div className="text-center bg-gray-50 px-3 py-2 rounded-lg">
                         ...
                         <div className="flex items-center gap-4 col-span-2">
                            <div className="flex-1">
                               <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Trip Reference</p>
                               <p className="text-sm font-bold text-gray-800 flex items-center gap-2">
                                 Journey <ChevronRight className="h-3 w-3" /> {ticket.tripId.substring(0,6)}
                               </p>
                            </div>
                            <div>
                    ...
                    <div className="bg-gray-50 p-8 flex flex-col items-center justify-center md:border-l border-gray-200 min-w-[200px]">
                       ...
                       <div className="text-center mb-6">
                          ...
                          <p className="text-xl font-black text-primary">{ticket.totalPrice?.toLocaleString()} RWF</p>
                       </div>
