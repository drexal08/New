      ...
      <main>
        ...
        <section className="relative h-[700px] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full text-white text-sm font-bold mb-6 border border-white/20 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="relative z-20 animate-in fade-in zoom-in-95 duration-1000 delay-300">
        ...
        <section className="py-12 bg-gray-50 border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 flex flex-col md:flex-row items-center transition-all hover:scale-[1.01] hover:shadow-xl duration-300">
              <div className="p-8 md:p-12 flex-grow">
                ...
                <Button className="bg-gray-900 text-white hover:bg-black rounded-full px-10 h-14 font-bold text-lg transition-all active:scale-95">Get Move App</Button>
              </div>
              {moveAd && (
                <div className="relative h-64 md:h-80 w-full md:w-1/2 group overflow-hidden">
                  <Image 
                    src={moveAd.imageUrl} 
                    alt="Move Ride" 
                    fill 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap justify-center gap-16">
               {[
                 ...
                 <div key={i} className="flex flex-col items-center gap-4 group animate-in zoom-in duration-500" style={{ animationDelay: `${i * 100}ms` }}>
                   <div className={`${pay.color} w-20 h-20 rounded-3xl flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
                     <pay.icon className="h-10 w-10 text-white" />
                   </div>
                   <span className="font-black text-gray-700 uppercase tracking-widest text-xs group-hover:text-primary transition-colors">{pay.label}</span>
                 </div>
               ))}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                <div key={i} className="p-10 rounded-[2.5rem] bg-white border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                  <div className={`bg-${feat.color}/10 p-5 rounded-2xl w-fit mb-8 group-hover:bg-${feat.color} transition-colors duration-300`}>
                    <feat.icon className={`h-10 w-10 text-${feat.color} group-hover:text-white`} />
                  </div>
                  <h3 className="text-2xl font-bold mb-4 text-gray-900 group-hover:text-primary transition-colors">{feat.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-1 lg:grid-cols-4 gap-16 mb-20">
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-4">
                 <div className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-accent transition-all duration-300 cursor-pointer active:scale-95"><Globe className="h-5 w-5" /></div>
                 <div className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-accent transition-all duration-300 cursor-pointer active:scale-95"><Smartphone className="h-5 w-5" /></div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-6">
                <div>
                  ...
                  <ul className="space-y-3 text-gray-400 text-sm">
                    <li><Link href="/search?to=Musanze" className="hover:text-white hover:pl-2 transition-all">Musanze</Link></li>
                    <li><Link href="/search?to=Rubavu" className="hover:text-white hover:pl-2 transition-all">Rubavu</Link></li>
                    <li><Link href="/search?to=Gicumbi" className="hover:text-white hover:pl-2 transition-all">Gicumbi</Link></li>
                    <li><Link href="/search?to=Karongi" className="hover:text-white hover:pl-2 transition-all">Karongi</Link></li>
                  </ul>
                </div>
                <div>
                  <p className="text-accent text-[10px] font-black uppercase tracking-widest mb-3">South & East</p>
                  <ul className="space-y-3 text-gray-400 text-sm">
                    <li><Link href="/search?to=Huye" className="hover:text-white hover:pl-2 transition-all">Huye</Link></li>
                    <li><Link href="/search?to=Rwamagana" className="hover:text-white hover:pl-2 transition-all">Rwamagana</Link></li>
                    <li><Link href="/search?to=Nyagatare" className="hover:text-white hover:pl-2 transition-all">Nyagatare</Link></li>
                    <li><Link href="/search?to=Rusizi" className="hover:text-white hover:pl-2 transition-all">Rusizi</Link></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400 text-sm">
                <li className="flex items-center gap-2 group cursor-default"><MapPin className="h-3 w-3 text-accent group-hover:scale-125 transition-transform" /> Nyabugogo Main Park</li>
                <li className="flex items-center gap-2 group cursor-default"><MapPin className="h-3 w-3 text-accent group-hover:scale-125 transition-transform" /> Remera Terminal</li>
                <li className="flex items-center gap-2 group cursor-default"><MapPin className="h-3 w-3 text-accent group-hover:scale-125 transition-transform" /> Musanze International</li>
                <li className="flex items-center gap-2 group cursor-default"><MapPin className="h-3 w-3 text-accent group-hover:scale-125 transition-transform" /> Rubavu Main Terminal</li>
                <li className="flex items-center gap-2 group cursor-default"><MapPin className="h-3 w-3 text-accent group-hover:scale-125 transition-transform" /> Huye Taxi Park</li>
              </ul>
            </div>
          ...
          <div className="pt-12 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-8">
              ...
              <Link href="/admin/dashboard" className="text-accent hover:text-white transition-all text-xs font-black uppercase tracking-widest hover:underline">Admin Access</Link>
            </div>
          </div>
        </div>
      </footer>
