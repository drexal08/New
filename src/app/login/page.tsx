...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Welcome back!", description: "Signing into your account." });
    } catch (error: any) {
  ...
  if (isUserLoading) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center">
        ...
        <p className="font-semibold text-muted-foreground uppercase tracking-widest text-[10px]">Verifying Credentials...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
      <Link href="/" className="mb-8 flex items-center gap-2 text-primary font-bold hover:underline transition-all active:scale-95 text-xs uppercase tracking-widest">
      ...
      <Card className="w-full max-w-md border-none shadow-2xl rounded-2xl overflow-hidden bg-white">
        ...
        <CardContent className="p-8 md:p-10 space-y-6">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" size="sm" className="text-[10px] font-bold uppercase text-primary hover:underline tracking-widest">Forgot?</Link>
              </div>
              <div className="relative">
            ...
            <Button type="submit" className="w-full h-12 rounded-xl font-bold bg-primary hover:bg-primary/90 transition-all active:scale-95 shadow-lg shadow-primary/10" disabled={isSubmitting}>
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-widest"><span className="bg-white px-3 text-muted-foreground">Or</span></div>
          </div>
          ...
          <Button 
            ...
            className="w-full h-12 rounded-xl border-gray-100 hover:bg-gray-50 font-bold gap-3 transition-all"
