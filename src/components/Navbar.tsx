...
import { Bus, User, Ticket, Menu, LayoutDashboard } from "lucide-react";
        ...
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="flex items-center gap-2">
            ...
            <div className="flex flex-col -space-y-1">
              <span className="text-2xl font-black text-primary tracking-tighter">EZ BUS</span>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 p-2 rounded-2xl border-none shadow-2xl">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="rounded-xl p-3 cursor-pointer text-primary font-black uppercase text-xs tracking-widest text-center justify-center">
                  Sign In / Register
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          ...
          <div className="md:hidden">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 p-2 rounded-2xl border-none shadow-2xl">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="rounded-xl p-3 font-black uppercase text-xs tracking-widest text-primary">
                  Sign In
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
